...
public:
    Satellite(double s, double m, string c, string n, string host)
        : CelestialBody(s, m, c, n), host_planet(host)
    {}
...
public:
    Planet(double s, double m, string c, string n, string host)
        : CelestialBody(s, m, c, n), host_star(host)
    {}
    string GetHostStar()
    {
        return host_star;
